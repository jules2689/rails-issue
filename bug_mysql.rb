...
db_config = { adapter: "mysql2", database: "rails_issue", username: "root" }
ActiveRecord::Base.establish_connection(db_config.merge(database: nil))
ActiveRecord::Base.connection.create_database(db_config[:database]) rescue Mysql2::Error; nil
...
class BugTest < Minitest::Test
  ...
  # This will fail because 'true' is not cast
  ...
  # This will fail because 'true' is evaluated to false so we get the comment
